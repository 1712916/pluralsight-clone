                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          widget.course.createdAt!=null? buildSubTextTitle(DateFormat('yyyy-MM-dd').format(widget.course.createdAt)+""):Container(),
                          widget.course.totalHours!=null?buildSubTextTitle(double.parse((widget.course.totalHours).toStringAsFixed(3)).toString()+" h"):Container(),
                        ],
                      ),
                      Row(
                        mainAxisSize: MainAxisSize.min,
