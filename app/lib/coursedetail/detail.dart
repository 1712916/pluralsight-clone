...
import 'package:app/widget/RatingStar.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: widget.course.authors
                .map((e) => Padding(
                    ...
                    child: authorChip(findAuthorById(e))))
                .toList(),
          ),
          SizedBox(
            height: 8,
          ...
          Row(
            children: [
              Expanded(
                child:  actionButton('Bookmark', Icon(Icons.bookmark_border), (){}),
              ),
              Expanded(
                child:  actionButton('Add to Channel', Icon(Icons.wifi_tethering), (){}),
              ),
              Expanded(
                child:  actionButton('Downloaded', Icon(Icons.arrow_circle_down), (){}),
              ),
            ],
          ),
          SizedBox(
          ...
          actionButton2('View related paths & courses', Icon(Icons.done), (){}),
        ],
      ),
    );
  }
...
Widget authorChip(Author author) {
